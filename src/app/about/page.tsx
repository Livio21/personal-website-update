  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <Card className="md:col-span-3 lg:col-span-2 bg-card/60 backdrop-blur-sm border-white/10">
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-2xl font-semibold">
        ...
        <div className="md:col-span-3 lg:col-span-5 grid md:grid-cols-2 gap-6">
            {experience.map((exp) => (
