  ...
  return (
    <div className="w-full p-8 md:p-24 md:pl-32">
      <header className="mb-12">
        ...
        <p className="text-lg text-muted-foreground font-body">I'd love to hear from you. Let's build something great together.</p>
      </header>
      ...
      <div className="grid md:grid-cols-2 gap-10 bg-card/60 backdrop-blur-lg border border-border/20 rounded-lg p-8">
        ...
        <div>
          <h2 className="text-2xl font-semibold font-headline text-primary mb-6">Send a Message</h2>
          <ContactForm />
        </div>
      </div>
    </div>
