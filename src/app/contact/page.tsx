...
export default function ContactPage() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 md:p-16">
      <div className="grid md:grid-cols-2 gap-10 bg-card/40 backdrop-blur-lg border border-white/10 rounded-lg p-6 sm:p-8 w-full max-w-5xl">
